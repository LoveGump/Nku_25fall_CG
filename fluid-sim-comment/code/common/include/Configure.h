...
namespace Lagrangian2dPara
{
    ...
    // Moving solid parameters (2D)
    extern bool enableMovingSolid;
    extern glm::vec2 solidCenter;
    extern glm::vec2 solidVelocity;
    extern float solidRadius;
    extern float solidRestitution;
    extern float solidFriction;

    // Windmill parameters (2D)
    extern bool enableWindmill;
    extern glm::vec2 windmillCenter;
    extern float windmillBladeLength;
    extern float windmillBladeWidth;
    extern float windmillHubRadius;
    extern int windmillBladeCount;
    extern float windmillAngularVelocity;
    extern float windmillRestitution;
    extern float windmillFriction;

    // Incompressible solver parameters
    extern bool enableIncompressible;
    extern int incompressibleIterations;
...
namespace Lagrangian3dPara
{
    ...
    // 旋转木板参数
    extern bool enableRotatingBoard;
    extern glm::vec3 boardCenter;
    extern glm::vec3 boardSize;
    extern glm::vec3 boardRotationAxis;
    extern float boardAngularVelocity;
    extern float boardRestitution;
    extern float boardFriction;
