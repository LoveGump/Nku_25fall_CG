...
namespace FluidSimulation
{
    namespace Lagrangian2d
    {
        ...
        void Lagrangian2dComponent::init()
        {
            ...
            if (Lagrangian2dPara::enableMovingSolid)
            {
                ps->setMovingSolid(Lagrangian2dPara::solidCenter, Lagrangian2dPara::solidRadius,
                                   Lagrangian2dPara::solidVelocity, Lagrangian2dPara::solidRestitution, Lagrangian2dPara::solidFriction);
            }
            else
            {
                ps->disableMovingSolid();
            }

            if (Lagrangian2dPara::enableWindmill)
            {
                ps->setWindmill(Lagrangian2dPara::windmillCenter, Lagrangian2dPara::windmillBladeLength,
                                Lagrangian2dPara::windmillBladeWidth, Lagrangian2dPara::windmillHubRadius,
                                Lagrangian2dPara::windmillBladeCount, Lagrangian2dPara::windmillAngularVelocity,
                                Lagrangian2dPara::windmillRestitution, Lagrangian2dPara::windmillFriction);
            }
            else
            {
                ps->disableWindmill();
